      ...
      ">
        ...
        <div className="col-span-2 sm:col-span-3 lg:col-span-1 space-y-3">
          ...
          <div className="pt-2 space-y-1.5 text-xs font-semibold">
            ...
            <a
              href={socialLinks.whatsapp || `https://wa.me/${(socialLinks.whatsappNumber || '919818946081').replace(/[^0-9]/g, '')}`}
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <span>WA: <strong className="text-white">{socialLinks.whatsappNumber || '+91 98189 46081'}</strong></span>
            </a>
          </div>
        </div>
